...
public class SingleThread extends Thread
{
        ...
        try
        {
            ...
            if (!httpHeader.equals("")) {
                ...
                else if (request[0].equals("PUT"))
                {
                    ...
                    FilePath += request[1];
                    System.out.println("Client HTTP Request Body: " + CRLF + requestBody);
                    processRequestPUT(FilePath, requestBody);
                }
            }
    ...
    public void processRequestGET(String FilePath) throws Exception
    {
        ...
        if(file.exists() && (FilePath.contains(".html") || FilePath.contains(".txt"))) // if file exists
        {
    ...
    public void processRequestPUT(String FilePath, String RequestBody) throws Exception{
        File file = new File(FilePath);
